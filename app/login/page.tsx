                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4 pt-4">
                            ...
                            <button
                                ...
                                className="group relative w-full flex items-center justify-center gap-3 px-4 py-4 border border-gray-200 text-base font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                            >
                            ...
                            <button
                                ...
                                className="group relative w-full flex items-center justify-center gap-3 px-4 py-4 border border-transparent text-base font-medium rounded-xl text-white bg-[#0A66C2] hover:bg-[#004182] hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0A66C2]"
                            >
